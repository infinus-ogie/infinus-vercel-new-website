...
const PAGE_CONTENT = {
  ...
  technologies: "SAP ERP, SAP S/4HANA, multiple functional and technical modules (FI, CO, MM, SD, PP, QM, EWM, ABAP, BC, SAC)",
}

export const metadata = generatePageMetadata(
  "Nearshoring Case Study | Infinus",
...
const pageConfig = createSimplePageConfig(
  ...
  "Nearshoring Case Study | Infinus",
  PAGE_CONTENT.clientOverview,
  { articleAbout: ["SAP", "Nearshoring", "Case Study", "Infinus"] }
)

export default function NearshoringCaseStudyPage() {
  return (
    <>
      ...
      <section className="relative overflow-hidden min-h-[60vh] sm:min-h-[75vh]">
        <Image
          src="/case-study/nearshoring-hero.jpg"
          alt="Nearshoring Case Study"
          fill
          priority
