 ...
 *
 * The strings are unchanged. The only thing this migration moved is PATH — now /sr/grow/cfo —
 * which updates og:url, the self-canonical and the hreflang pair. The English counterpart is
 * /grow/cfo, the clean path this page used to occupy.
 */

const PATH = pairPath("grow-cfo", "sr");
const content = getDictionary("sr").growth.cfo;
