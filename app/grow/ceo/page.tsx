...
import { CeoTimeline } from "./_sections/CeoTimeline";
...
const jsonLdData = [
  ...
  {
    "@type": "Article",
    headline: "SAP for CEOs",
    about: ["SAP Cloud ERP", "Business AI", "CEO"],
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <ProServicesHero
          ...
          bgImage="/SAP%20for%20CEO%20images/hero-ceo-2.png"
        />
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6">
              <div className="inline-flex items-center gap-3 rounded-full border border-[#0a6ed1]/20 bg-gradient-to-br from-blue-50/80 to-indigo-50/60 backdrop-blur px-6 py-3.5 shadow-sm transition-all duration-200 hover:shadow-md hover:border-[#0a6ed1]/40 hover:scale-105 cursor-default">
                <Zap className="h-5 w-5 text-[#0a6ed1] flex-shrink-0" />
                <div className="text-left">
                  <div className="text-sm font-semibold text-slate-900">Brže odluke uz AI</div>
                  <div className="text-xs text-slate-600">upiti na prirodnom jeziku</div>
                </div>
              </div>
              ...
              <div className="inline-flex items-center gap-3 rounded-full border border-[#0a6ed1]/20 bg-gradient-to-br from-blue-50/80 to-indigo-50/60 backdrop-blur px-6 py-3.5 shadow-sm transition-all duration-200 hover:shadow-md hover:border-[#0a6ed1]/40 hover:scale-105 cursor-default">
                ...
                <div className="text-left">
                  <div className="text-sm font-semibold text-slate-900">Predvidivost rasta</div>
                  <div className="text-xs text-slate-600">rolling forecast i scenariji</div>
                </div>
              </div>
              ...
              <div className="inline-flex items-center gap-3 rounded-full border border-[#0a6ed1]/20 bg-gradient-to-br from-blue-50/80 to-indigo-50/60 backdrop-blur px-6 py-3.5 shadow-sm transition-all duration-200 hover:shadow-md hover:border-[#0a6ed1]/40 hover:scale-105 cursor-default">
                ...
                <div className="text-left">
                  <div className="text-sm font-semibold text-slate-900">Bolji cash-flow</div>
                  <div className="text-xs text-slate-600">kraći DSO/DIO/DPO</div>
                </div>
              </div>
            </div>
          </motion.div>
