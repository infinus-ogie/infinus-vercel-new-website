...
import { generateProfessionalServicesJsonLd } from "./_jsonld";
import { professionalServicesConfig } from "./_config";

// Auto-generated JSON-LD - updates automatically when professionalServicesConfig changes
const jsonLdData = generateProfessionalServicesJsonLd();
      ...
      <main className="flex-1">
        ...
        <Section surface="surface-0">
          <motion.div 
            ...
            viewport={{ once: true, amount: 0.2 }}
          >
            <FaqSection id="faq-pro" items={professionalServicesConfig.faqs} />
          </motion.div>
        </Section>
